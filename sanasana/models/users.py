...
class Organization(db.Model):
    ...
    f_industry = db.Column(db.String(80), nullable=True)
    f_country = db.Column(db.String(80), nullable=True)
    f_email = db.Column(db.String(120), nullable=True)
    f_size = db.Column(db.Integer, nullable=True)
