    ...
    def post(self, org_id, user_id):
        try:
            ...
            new_asset = Asset(
                ...
                a_displacement=data.get('a_displacement', ''),
                a_mileage=data.get('a_mileage', ''),
                a_horsepower=data.get('a_horsepower', ''),
                a_acceleration=data.get('a_acceleration', ''),
                a_insurance_expiry=data.get('a_insurance_expiry', ''),
