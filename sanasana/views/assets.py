...
class   InternalCustomerMetric(Resource):
    def post(self, org_id):
        ...
        report = qasset.get_internal_customer_metric_report(start_date, end_date)
...
api_assets.add_resource(InternalCustomerMetric, '/reports/internal_customer_metrics/<org_id>/')
