...
def add_asset():
    ...
    required_fields = [
        'a_name', 'a_make', 'a_model', 'a_year', 'a_license_plate', 'a_type',
        'a_msrp', 'a_engine_size', 'a_tank_size',
        'a_fuel_type', 'a_cost', 'a_value', 'a_depreciation_rate',
        'a_status',  'a_efficiency_rate'
    ]
