...
Revision ID: 31e738799860
Revises: 548f6f2d8ece
Create Date: 2024-07-16 10:25:28.459465
...
revision = '31e738799860'
down_revision = '548f6f2d8ece'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.execute('DROP TABLE users.user CASCADE')
    ...
    sa.Column('a_organisation_id', sa.Integer(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['a_organisation_id'], ['users.firm.id'], ),
    sa.PrimaryKeyConstraint('id'),
    schema='assets'
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('trips', schema='assets', cascade=True)
    op.drop_table('operators', schema='assets', cascade=True)
    op.drop_table('assets', schema='assets', cascade=True)
    # ### end Alembic commands ###
