...
Revision ID: 196c4141f198
Revises: c4b8ad49e792
Create Date: 2024-07-27 23:18:08.377459
...
revision = '196c4141f198'
down_revision = 'c4b8ad49e792'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('c_assign_by', sa.String(), nullable=False),
    sa.Column('c_assigned_at', sa.DateTime(), nullable=False),
    sa.Column('c_assigned_to', sa.Integer(), nullable=False),
    sa.Column('c_number', sa.String(), nullable=False),
    sa.Column('c_expiry_date', sa.DateTime(), nullable=False),
    ...
    sa.Column('f_cost', sa.Float(), nullable=False),
    sa.Column('f_total_cost', sa.Float(), nullable=False),
    sa.Column('f_distance', sa.Float(), nullable=False),
