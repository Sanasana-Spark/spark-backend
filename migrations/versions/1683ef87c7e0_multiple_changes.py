...
Revision ID: 1683ef87c7e0
Revises: a0e85bca724d
Create Date: 2025-02-13 11:40:09.647648
...
revision = '1683ef87c7e0'
down_revision = 'a0e85bca724d'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('a_attached_card', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['a_attached_card'], ['assets.cards.id'], ),
